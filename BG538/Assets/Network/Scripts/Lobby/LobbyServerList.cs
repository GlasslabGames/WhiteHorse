    ...
    public class LobbyServerList : MonoBehaviour
    {
        ...
        public void OnGUIMatchList(ListMatchResponse response)
        {
            ...
            for (int i = 0; i < response.matches.Count; ++i)
            {
                ...
                //TODO o.GetComponent<LobbyServerEntry>().Populate(response.matches[i], lobbyManager, (i%2 == 0) ? OddServerColor : EvenServerColor);
        ...
        public void RequestPage(int page)
        {
            ...
            currentPage = page;
			Debug.Log ("LobbyManager: "+lobbyManager, lobbyManager);
			Debug.Log ("Matchmaker: "+lobbyManager.matchMaker);
