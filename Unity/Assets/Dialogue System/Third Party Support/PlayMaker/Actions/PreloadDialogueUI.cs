...
namespace PixelCrushers.DialogueSystem.PlayMaker {
	...
	[HutongGames.PlayMaker.TooltipAttribute("Preloads the Dialogue Manager's dialogue UI, which is normally loaded just before the first conversation/bark/alert.")]
