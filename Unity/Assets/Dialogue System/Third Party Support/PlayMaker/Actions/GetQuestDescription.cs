...
namespace PixelCrushers.DialogueSystem.PlayMaker {
	...
	[HutongGames.PlayMaker.TooltipAttribute("Gets the description of a quest.")]
	public class GetQuestDescription : FsmStateAction {
		...
		[HutongGames.PlayMaker.TooltipAttribute("Get the description for this quest state (unassigned, active, success, or failure) or leave blank for the current state")]
