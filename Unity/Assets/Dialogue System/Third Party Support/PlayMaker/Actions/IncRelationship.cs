...
namespace PixelCrushers.DialogueSystem.PlayMaker {
	...
	[HutongGames.PlayMaker.TooltipAttribute("Increments a relationship value between two actors.")]
	public class IncRelationship : FsmStateAction {
		...
		[RequiredField]
		[HutongGames.PlayMaker.TooltipAttribute("The amount to increment the relationship value")]
