...
{
  public event OnDragEventHandler OnDragStart;
  public event OnDragEventHandler OnDragEnd;
  public event OnDragEventHandler OnDrop; // after all the processing of a drop
  public delegate void GLDragDropItemDel( GLDragDropItem item );
  public event GLDragDropItemDel OnDrag; // constantly when the item is being dragged
  ...
  protected override void OnDragDropEnd()
  {
    ...
    if (mDragScrollView != null) {
      ...
      if (grid != null) {
        ...
        EventDelegate.Add (grid.onReposition, delegate() {
